...
export function Addon() {
  ...
  const api = "http://api.mrrung.com/view_addon/";
  useEffect(() => {
    fetch(api)
      .then((response) => {
        if (!response.ok) {
  ...
  const handleEditFormSubmit = (e: React.FormEvent) => {
    ...
    axios
      .post("http://api.mrrung.com/add_addon/", selectedEditItem)
      .then((response) => {
  ...
  const handleDeleteAddOn = (name: string) => {
    axios
      .delete(`http://api.mrrung.com/delete_add_on/${name}/`)
      .then((response) => {
  ...
  const handleAddSubmit = (e: React.FormEvent) => {
    ...
    console.log(addData);
    axios
      .post("http://api.mrrung.com/add_addon/", addData)
      .then((response) => {
        console.log("Server Response:", response.data);
        toast.success("Addon added/edited  successfully!");
        setTimeout(() => {
  ...
  const apis = "http://api.mrrung.com/add_on_food/";
  useEffect(() => {
    fetch(apis)
      .then((response) => {
        if (!response.ok) {
  ...
  const handleAddOnFoodSubmit = (e: React.FormEvent) => {
    ...
    // Assuming your backend endpoint is 'http://api.mrrung.com/add_on_food/'
    axios
      .post("http://api.mrrung.com/add_addon_food/", addOnFoodData)
      .then((response) => {
        console.log("Server Response:", response.data);
  ...
  const handleDeleteAddOnFood = (id) => {
    axios
      .delete(`http://api.mrrung.com/delete_addon_food/${id}/`)
      .then((response) => {
        console.log("Delete Response:", response.data);
