...
export function EditMenu() {
  ...
  const api = "http://api.mrrung.com/all_values/";
  useEffect(() => {
    fetch(api)
      .then((response) => {
        if (!response.ok) {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.language === "english") {
      ...
      axios
        .post("http://api.mrrung.com/add_menu/", formData)
        .then((response) => {
      ...
      delete formData.language;
      axios
        .post("http://api.mrrung.com/add_menu_germen/", formData)
        .then((response) => {
          // console.log("Server Response:", response.data);
          const add = () => toast.success("Menu added successfully!");
          add();
  ...
  const handleAvailabilityChange = useCallback((name, available, language) => {
    ...
    const apiUrl =
      language === "english"
        ? `http://api.mrrung.com/menu_availability/${name}/`
        : `http://api.mrrung.com/menu_availability_germen/${name}/`;
  ...
  const handleDelete = (name, language) => {
    if (language === "english") {
      axios
        .delete(`http://api.mrrung.com/delete_menu/${name}/`)
        .then((response) => {
      ...
      axios
        .delete(`http://api.mrrung.com/delete_menu_germen/${name}/`)
        .then((response) => {
          // console.log("Delete Response:", response.data);
          const deleted = () => toast.success("Deleted menu successfully!");
          deleted();
  ...
  const handleEditFormSubmit = (e) => {
    ...
    if (editModalLanguage === "english") {
      ...
      // Assuming your backend endpoint is 'http://api.mrrung.com/submit_data/'
      axios
        .post("http://api.mrrung.com/add_menu/", selectedEditItem)
        .then((response) => {
          // console.log("Server Response:", response.data);
      ...
      axios
        .post(
          "http://api.mrrung.com/add_menu_germen/",
          selectedEditItem,
        )
        .then((response) => {
          // console.log("Server Response:", response.data);
